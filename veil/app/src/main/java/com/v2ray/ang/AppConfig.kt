...
object AppConfig {
    ...
    const val PREF_LAST_UPDATE_NOTIFIED_VERSION = "pref_last_update_notified_version"
    ...
    const val APP_URL = "$GITHUB_URL/venterum/veil"
    const val APP_ORIGINAL_URL = "$GITHUB_URL/2dust/v2rayNG"
    const val APP_API_URL = "https://api.github.com/repos/venterum/veil/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/2dust/v2rayNG/master/CR.md"
    const val TG_CHANNEL_URL = "https://t.me/vntrum_public"
